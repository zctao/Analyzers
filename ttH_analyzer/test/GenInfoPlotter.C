...
void GenInfoPlotter (const TString input_file = "/uscms/home/ztao/work/CU_ttH_WD/Outputs/CU_ttH_EDA_output.root") {
	...
	for (int ievt=0; ievt<nevt; ++ievt) {
		...
		top1.SetPtEtaPhiM(gen_top_pt->at(imax), gen_top_eta->at(imax), gen_top_phi->at(imax), gen_top_mass->at(imax));
		top2.SetPtEtaPhiM(gen_top_pt->at(imin), gen_top_eta->at(imin), gen_top_phi->at(imin), gen_top_mass->at(imin));
